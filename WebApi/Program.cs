...
namespace WebApi
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IEntregadorRepositorio<Entregador>, EntregadorRepositorioInMemory>();
            ...
            builder.Services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc("v1", new OpenApiInfo
                    {
                        Version = "v1",
                        Title = "Imoveis API",
                        Description = "An API for managing real estate properties, allowing operations such as adding, retrieving, updating, and deleting properties",
